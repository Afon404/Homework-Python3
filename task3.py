...
if word != eng:
	...
	print('За английское слово вы получаете: ', sum([k for i in word for k, v in eng.items() if i in v]), 'очков')
...
if word != rus:
	...
	print('За русское  слово вы получаете: ', sum([k for i in word for k, v in rus.items() if i in v]), 'очков')
else:
    print('Error!')